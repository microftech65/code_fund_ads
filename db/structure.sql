...
CREATE TABLE public.insertion_orders (
    ...
    company_address_1 character varying NOT NULL,
    company_address_2 character varying,
    company_city character varying NOT NULL,
    company_region character varying NOT NULL,
    company_postal_code character varying NOT NULL,
    ...
    billing_contact_first_name character varying NOT NULL,
    billing_contact_last_name character varying NOT NULL,
    billing_contact_email character varying NOT NULL,
    billing_contact_phone character varying NOT NULL,
    notes text
);
